...
custom_imports = dict(
    imports=['projects.mmdet3d_plugin.models.vlm.spacedrive_focusvla'],
...
# Effective batch = num_gpus * batch_size * cumulative_iters (e.g. 2*2*2 = 8, same as 8*1).
...
# FocusVLA experimental config
focus_vla_enabled = True
focus_vla_top_k = 64
focus_vla_alpha = 1.0
...
# save paths
base_path = 'workspace/spacedrive_qwen_focusvla/'
work_dir = base_path
