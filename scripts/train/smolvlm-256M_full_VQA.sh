#!/usr/bin/env bash
# SmolVLM-256M full fine-tuning (all parameters) on NuScenes VQA data
# Target HW: 1x A6000 48GB
# Usage:
#   bash scripts/train/smolvlm-256M_full.sh
#   bash scripts/train/smolvlm-256M_full.sh --num_train_epochs 10
...
OUTPUT_DIR="${OUTPUT_DIR:-workspace/smolvlm-256M-full}"
GPUS="${GPUS:-1}"
